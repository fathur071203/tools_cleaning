...
st.markdown(
    ...
    <div style="
        ...
        color: white;
    ">
        <div style="font-size: 22px; font-weight: 800; line-height: 1.15;">📊 Data Cleaning Perlindungan Konsumen</div>
        <div style="font-size: 13px; opacity: 0.95; margin-top: 3px;">Upload Excel → proses otomatis 3 mode → download hasil</div>
    </div>
    """,
    unsafe_allow_html=True,
)
st.caption("Upload Excel → proses cepat 3 mode → download hasil.")
...
run_clicked = st.button("⚡ Proses Data", type="primary", use_container_width=True, disabled=(uploaded is None))
